...
diagnosis <- function(content, measure, year, pmid, sortby, lefthand,
  ...
  # Method 3
  # madauni
  meta3 <- mada::madauni(myframe, correction = 0.5, correction.control = "all")
	...
	svgtext = paste(svgtext, '<text x="10" y="' , 115 + i*20 , '"', style_bold, ">", "Heterogeneity: ", round(I2,1), "%</text>", sep = "")
	svgtext = paste(svgtext, '<text x="10" y="', 130 + i*20 ,'"', style_normal, ">(For diagnostic odds ratio: Q = ",round(meta3$CQ['Q'],1),", DF = ",meta3$CQ['df'],")</text>",sep="")
#predictive values
